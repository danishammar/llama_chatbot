...
st.markdown("Built by [Danish Ammar](https://mycodelive.com/)")
...
with st.sidebar:
    ...
    Join [mycodelive.com](https://mycodelive.com/) by Danish Ammar!
    """)
    add_vertical_space(3)
    st.write("Reach out to me on [LinkedIn](https://www.linkedin.com/in/danishammar/)")
